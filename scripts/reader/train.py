...
# Defaults
DATA_DIR = 'scripts/reader'
MODEL_DIR = 'scripts/reader'
EMBED_DIR ='scripts/reader'
...
def add_train_args(parser):
    ...
    files.add_argument('--dev-json', type=str, default='dev-v2.0.json',
...
def eval_accuracies(pred_s, target_s, pred_e, target_e):
    ...
    for i in range(batch_size):
        ...
        if pred_s[i] in target_s[i] and pred_e[i] in target_e[i]:
            em.update(1)
        else:
            em.update(0)
